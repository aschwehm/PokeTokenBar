...
> ⚠️ **Status: planning / pre-MVP.** The repository currently contains design documentation only.
> No buildable code yet. See [docs/roadmap.md](docs/roadmap.md) for what's next.
